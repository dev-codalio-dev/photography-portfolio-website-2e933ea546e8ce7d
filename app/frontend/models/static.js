const api = {
  ...
  "components": {
    "schemas": {
      ...
      "license": {
        "x-rhino-model": {
          "model": "license",
          "modelPlural": "licenses",
          "name": "license",
          "pluralName": "licenses",
          "readableName": "License",
          "pluralReadableName": "Licenses",
          "ownedBy": "organization",
          "singular": false,
          "path": "/api/licenses",
          "searchable": false
      ...
      "order_item": {
        "x-rhino-model": {
          "model": "order_item",
          "modelPlural": "order_items",
          "name": "orderItem",
          "pluralName": "orderItems",
          "readableName": "Order item",
          "pluralReadableName": "Order items",
          "ownedBy": "order",
          "singular": false,
  ...
  "paths": {
    ...
    "/api/order_items/:id": {
      ...
      "delete": {
        "operationId": "order_item-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
